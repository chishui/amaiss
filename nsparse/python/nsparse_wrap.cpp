 ...
 *
 * Note that SWIG expects __cplusplus to be defined to the appropriate C++
 * standard. MSVC users are urged to check and examine the /Zc:__cplusplus
 * compiler option. See
...
typedef struct swig_cast_info {
    ...
    struct swig_cast_info* next; /* pointer to next array of casts | pointer to
                                    cast hashed by value */
    unsigned int value; /* index of the last valid element in the array |
                           typename hash value */
} swig_cast_info;
...
/*
 * Hash function for type name strings, based on maRushPrime1Hash
                ...
                if (search) {
                    ...
                    do {
                        ...
                        if (iter->value < hash_value) {
                            ...
                            for (last = iter + 1;
                                 last->next && last->value == hash_value;
                                 last++) {
                            ...
                            for (first = iter - 1;
                                 first != head && first->value == hash_value;
                                 first--) {
...
/* Increment and Decrement wrappers - for portability when using the stable abi
 * and for performance otherwise */
...
#define SWIG_Py_XDECREF Py_XDECREF
    ...
    (!defined(Py_LIMITED_API) || Py_LIMITED_API + 0 >= 0x030d00a6)
...
SWIGINTERN PyObject* SWIG_PyType_GetFullyQualifiedName(PyTypeObject* type) {
    ...
    PyObject* qualname =
        PyObject_GetAttrString((PyObject*)type, "__qualname__");
    if (qualname) {
        PyObject* mod = PyObject_GetAttrString((PyObject*)type, "__module__");
        if (mod) {
            if (PyUnicode_Check(mod) &&
                PyUnicode_CompareWithASCIIString(mod, "builtins") &&
                PyUnicode_CompareWithASCIIString(mod, "__main__")) {
...
/* gh-114329 added PyList_GetItemRef() to Python 3.13.0a4 */
    ...
    (!defined(Py_LIMITED_API) || Py_LIMITED_API + 0 >= 0x030d00a4)
...
/* gh-106004 added PyDict_GetItemRef() and PyDict_GetItemStringRef() to
   Python 3.13.0a1 functions are renamed here for compatibility with abi3audit
 */
#if (PY_VERSION_HEX >= 0x030d00a1) && \
    (!defined(Py_LIMITED_API) || Py_LIMITED_API + 0 >= 0x030d00a1)
#define SWIG_PyDict_GetItemRef PyDict_GetItemRef
#define SWIG_PyDict_GetItemStringRef PyDict_GetItemStringRef
#else
SWIGINTERN int SWIG_PyDict_GetItemRef(PyObject* mp, PyObject* key,
                                      PyObject** result) {
#if PY_VERSION_HEX >= 0x03000000
...
SWIGINTERN int SWIG_PyDict_GetItemStringRef(PyObject* mp, const char* key,
                                            PyObject** result) {
    int res;
#if PY_VERSION_HEX >= 0x03000000
...
/* Create/obtain the single swig_runtime_data module which is used across
 * different SWIG generated modules */
SWIGINTERN PyObject* SWIG_runtime_data_module(void) {
    ...
    (!defined(Py_LIMITED_API) || Py_LIMITED_API + 0 >= 0x030d0000)
        /* free-threading note: the GIL is always enabled when this function is
           first called by SWIG_init, so there's no risk of race conditions */
        Swig_runtime_data_module_global =
    ...
    if (!args) {
        if (!min && !max) {
            ...
            PyErr_Format(PyExc_TypeError,
                         "%s expected %s%d arguments, got none", name,
...
SWIGINTERN PyTypeObject* SwigVarLink_TypeOnce(void) {
    ...
    if (!type_init) {
        ...
        if (PyModule_AddObject(runtime_data_module, "SwigVarLink",
                               (PyObject*)&varlink_type) == 0)
            SWIG_Py_INCREF((PyObject*)&varlink_type);
    }
    return &varlink_type;
#else
    PyType_Slot slots[] = {{Py_tp_dealloc, (void*)SwigVarLink_dealloc},
                           ...
                           {0, NULL}};
    PyType_Spec spec = {SWIG_RUNTIME_MODULE ".SwigVarLink",
                        sizeof(swig_varlinkobject), 0, Py_TPFLAGS_DEFAULT,
                        slots};
    PyObject* pytype = PyType_FromSpec(&spec);
    PyObject* runtime_data_module = SWIG_runtime_data_module();
    if (pytype &&
        PyModule_AddObject(runtime_data_module, "SwigVarLink", pytype) == 0)
...
SWIGINTERN PyObject* SWIG_Python_newvarlink(void) {
    swig_varlinkobject* result =
        PyObject_New(swig_varlinkobject, SwigVarLink_Type());
    if (result) {
        result->vars = 0;
    }
...
SWIGRUNTIME PyObject* SwigPyObject_get___dict__(
    ...
    if (!sobj->swigdict) sobj->swigdict = PyDict_New();
...
SWIGRUNTIME PyObject* SwigPyObject_richcompare(PyObject* v, PyObject* w,
                                               int op) {
    PyObject* res = NULL;
    if (!PyErr_Occurred()) {
        /* Per
         * https://docs.python.org/3/c-api/typeobj.html#c.PyTypeObject.tp_richcompare
         * the first argument is guaranteed to be an instance of SwigPyObject,
         * but the second is not, so we typecheck that one. */
...
SWIGRUNTIMEINLINE int SwigPyObject_Check(PyObject* op) {
    ...
    if (op_type == target_tp) {
        ...
        if (!tpname) return 0;
        cmp = PyUnicode_CompareWithASCIIString(
            tpname, SWIG_RUNTIME_MODULE ".SwigPyObject");
        SWIG_Py_DECREF(tpname);
        return cmp == 0;
#else
        return strcmp(op_type->tp_name, SWIG_RUNTIME_MODULE ".SwigPyObject") ==
               0;
#endif
    }
#endif
...
SWIGRUNTIME void SwigPyObject_dealloc(PyObject* v) {
    ...
    if (sobj->own == SWIG_POINTER_OWN) {
        ...
        if (destroy) {
            ...
            printf(
                "swig/python detected a memory leak of type '%s', no "
                "destructor found.\n",
                (name ? name : "unknown"));
        }
#endif
...
SWIGRUNTIME PyTypeObject* SwigPyObject_TypeOnce(void) {
    ...
    if (!type_init) {
        ...
        if (PyModule_AddObject(runtime_data_module, "SwigPyObject",
                               (PyObject*)&swigpyobject_type) == 0)
            SWIG_Py_INCREF((PyObject*)&swigpyobject_type);
    }
    return &swigpyobject_type;
#else
    static PyMemberDef SwigPyObject_members[] = {
        {(char*)"__dictoffset__", Py_T_PYSSIZET,
         offsetof(SwigPyObject, swigdict), Py_READONLY, NULL},
        {(char*)"__weaklistoffset__", Py_T_PYSSIZET,
         offsetof(SwigPyObject, weakreflist), Py_READONLY, NULL},
        {NULL, 0, 0, 0, NULL}};
    PyType_Slot slots[] = {{Py_tp_dealloc, (void*)SwigPyObject_dealloc},
                           ...
                           {0, NULL}};
    PyType_Spec spec = {SWIG_RUNTIME_MODULE ".SwigPyObject",
                        sizeof(SwigPyObject), 0,
                        Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE, slots};
    PyObject* pytype = PyType_FromSpec(&spec);
    PyObject* runtime_data_module = SWIG_runtime_data_module();
#if !defined(Py_LIMITED_API)
/* While this __dictoffset__ is only used with the builtin wrappers,
   SwigPyObject ought to be identical when created for use by proxy class
   wrappers in case it is shared across multiple modules. */
#if PY_VERSION_HEX < 0x03090000
    /* Workaround as __dictoffset__ and __weaklistoffset__ above are only
     * supported from python-3.9 */
    if (pytype) {
        ((PyTypeObject*)pytype)->tp_dictoffset =
            offsetof(SwigPyObject, swigdict);
        ((PyTypeObject*)pytype)->tp_weaklistoffset =
            offsetof(SwigPyObject, weakreflist);
    }
#endif
#endif
    if (pytype &&
        PyModule_AddObject(runtime_data_module, "SwigPyObject", pytype) == 0)
        SWIG_Py_INCREF(pytype);
    return (PyTypeObject*)pytype;
#endif
}
...
SWIGRUNTIMEINLINE int SwigPyPacked_Check(PyObject* op) {
    ...
    if (op_type == target_tp) {
        ...
        if (!tpname) return 0;
        cmp = PyUnicode_CompareWithASCIIString(
            tpname, SWIG_RUNTIME_MODULE ".SwigPyPacked");
        SWIG_Py_DECREF(tpname);
        return cmp == 0;
#else
        return strcmp(op_type->tp_name, SWIG_RUNTIME_MODULE ".SwigPyPacked") ==
               0;
#endif
    }
}
...
SWIGRUNTIME PyTypeObject* SwigPyPacked_TypeOnce(void) {
    ...
    if (!type_init) {
        ...
        if (PyModule_AddObject(runtime_data_module, "SwigPyPacked",
                               (PyObject*)&swigpypacked_type) == 0)
    ...
    PyType_Slot slots[] = {{Py_tp_dealloc, (void*)SwigPyPacked_dealloc},
                           ...
                           {0, NULL}};
    PyType_Spec spec = {SWIG_RUNTIME_MODULE ".SwigPyPacked",
                        sizeof(SwigPyPacked), 0, Py_TPFLAGS_DEFAULT, slots};
    PyObject* pytype = PyType_FromSpec(&spec);
    PyObject* runtime_data_module = SWIG_runtime_data_module();
    if (pytype &&
        PyModule_AddObject(runtime_data_module, "SwigPyPacked", pytype) == 0)
        SWIG_Py_INCREF(pytype);
    return (PyTypeObject*)pytype;
#endif
}
...
SWIGRUNTIME int SWIG_Python_ConvertFunctionPtr(PyObject* obj, void** ptr,
    ...
    if (!PyCFunction_Check(obj)) {
        ...
        PyObject* bytes = NULL;
        const char* doc =
            pystr_doc ? SWIG_PyUnicode_AsUTF8AndSize(pystr_doc, NULL, &bytes)
                      : 0;
#endif
...
#else
                newfunc newfn = (newfunc)PyType_GetSlot(
                    (PyTypeObject*)data->newargs, Py_tp_new);
#endif
                inst = newfn((PyTypeObject*)data->newargs, empty_args,
                             empty_kwargs);
...
SWIGRUNTIME void SWIG_Python_DestroyModule(PyObject* obj) {
    ...
    size_t i;
    if (--interpreter_counter != 0) /* another sub-interpreter may still be
                                       using the swig_module's types */
        return;
...
SWIGRUNTIME int SWIG_Python_AddErrMesg(const char* mesg, int infront) {
    if (PyErr_Occurred()) {
        ...
        if (value) {
            ...
            PyObject* bytes = NULL;
            const char* tmp =
                SWIG_PyUnicode_AsUTF8AndSize(old_str, NULL, &bytes);
...
SWIGRUNTIME int SWIG_Python_NonDynamicSetAttr(PyObject* obj, PyObject* name,
    ...
    if (PyString_Check(name)) {
        name = PyUnicode_Decode(PyString_AsString(name), PyString_Size(name),
                                NULL, NULL);
        if (!name) return -1;
    ...
    f = NULL;
    if (descr != NULL) f = Py_TYPE(descr)->tp_descr_set;
    if (!f) {
        if (PyString_Check(name)) {
            encoded_name = name;
            SWIG_Py_INCREF(name);
...
#define SWIGTYPE_p_nsparse__BrutalIndex swig_types[0]
#define SWIGTYPE_p_nsparse__Index swig_types[1]
#define SWIGTYPE_p_nsparse__SparseVectorView swig_types[2]
#define SWIGTYPE_p_nsparse__SparseVectors swig_types[3]
#define SWIGTYPE_p_char swig_types[4]
#define SWIGTYPE_p_float swig_types[5]
#define SWIGTYPE_p_int64_t swig_types[6]
#define SWIGTYPE_p_std__spanT_uint32_t_const_t swig_types[7]
#define SWIGTYPE_p_std__spanT_uint8_t_const_t swig_types[8]
#define SWIGTYPE_p_std__vectorT_float_t swig_types[9]
#define SWIGTYPE_p_std__vectorT_int64_t_t swig_types[10]
#define SWIGTYPE_p_std__vectorT_uint32_t_t swig_types[11]
...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#define SWIG_init PyInit__nsparse

#else
#define SWIG_init init_nsparse
...
SWIGINTERN int SWIG_AsVal_long(PyObject* obj, long* val) {
...
#ifdef SWIG_PYTHON_CAST_MODE
    {
        ...
        if (!dispatch) {
            ...
            // easily) Note that double(LONG_MAX) is stored in a double rounded
            // up by one (for 64-bit long) 0x7ffffffffffffc00LL ==
            // (int64_t)std::nextafter(double(__uint128_t(LONG_MAX)+1),
            // double(0))
            const double long_max =
                sizeof(long) == 8 ? 0x7ffffffffffffc00LL : LONG_MAX;
            // No equivalent needed for 64-bit double(LONG_MIN) is exactly
            // LONG_MIN
            if (SWIG_IsOK(res) &&
...
extern "C" {
#endif
SWIGINTERN PyObject* _wrap_SparseVectorView_indices_set(PyObject* self,
                                                        PyObject* args) {
    PyObject* resultobj = 0;
    nsparse::SparseVectorView* arg1 = 0;
    std::span<nsparse::term_t const> arg2;
    void* argp1 = 0;
    int res1 = 0;
    void* argp2;
    int res2 = 0;
    ...
    (void)self;
    if (!SWIG_Python_UnpackTuple(args, "SparseVectorView_indices_set", 2, 2,
                                 swig_obj))
        SWIG_fail;
    res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,
                           SWIGTYPE_p_nsparse__SparseVectorView, 0 | 0);
    if (!SWIG_IsOK(res1)) {
        SWIG_exception_fail(SWIG_ArgError(res1),
                            "in method '"
                            "SparseVectorView_indices_set"
                            "', argument "
                            "1"
                            " of type '"
                            "nsparse::SparseVectorView *"
                            "'");
    }
    arg1 = reinterpret_cast<nsparse::SparseVectorView*>(argp1);
    {
        res2 = SWIG_ConvertPtr(swig_obj[1], &argp2,
                               SWIGTYPE_p_std__spanT_uint32_t_const_t, 0 | 0);
        if (!SWIG_IsOK(res2)) {
        ...
        if (!argp2) {
            ...
            std::span<nsparse::term_t const>* temp =
                reinterpret_cast<std::span<nsparse::term_t const>*>(argp2);
            arg2 = *temp;
...
SWIGINTERN PyObject* _wrap_SparseVectorView_indices_get(PyObject* self,
                                                        PyObject* args) {
    PyObject* resultobj = 0;
    nsparse::SparseVectorView* arg1 = 0;
    void* argp1 = 0;
    int res1 = 0;
    PyObject* swig_obj[1];
    std::span<nsparse::term_t const> result;
    ...
    resultobj = SWIG_NewPointerObj(
        (new std::span<nsparse::term_t const>(result)),
        SWIGTYPE_p_std__spanT_uint32_t_const_t, SWIG_POINTER_OWN | 0);
    return resultobj;
fail:
    return NULL;
}

SWIGINTERN PyObject* _wrap_SparseVectorView_values_set(PyObject* self,
                                                       PyObject* args) {
    PyObject* resultobj = 0;
    nsparse::SparseVectorView* arg1 = 0;
    std::span<uint8_t const> arg2;
    void* argp1 = 0;
    int res1 = 0;
    void* argp2;
    int res2 = 0;
    ...
    (void)self;
    if (!SWIG_Python_UnpackTuple(args, "SparseVectorView_values_set", 2, 2,
                                 swig_obj))
        SWIG_fail;
    res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,
                           SWIGTYPE_p_nsparse__SparseVectorView, 0 | 0);
    ...
    {
        res2 = SWIG_ConvertPtr(swig_obj[1], &argp2,
                               SWIGTYPE_p_std__spanT_uint8_t_const_t, 0 | 0);
        if (!SWIG_IsOK(res2)) {
            SWIG_exception_fail(SWIG_ArgError(res2),
                                "in method '"
                                "SparseVectorView_values_set"
        ...
        if (!argp2) {
            ...
            std::span<uint8_t const>* temp =
                reinterpret_cast<std::span<uint8_t const>*>(argp2);
            arg2 = *temp;
            if (SWIG_IsNewObj(res2)) delete temp;
        }
    }
...
SWIGINTERN PyObject* _wrap_SparseVectorView_values_get(PyObject* self,
                                                       PyObject* args) {
    PyObject* resultobj = 0;
    nsparse::SparseVectorView* arg1 = 0;
    void* argp1 = 0;
    ...
    arg1 = reinterpret_cast<nsparse::SparseVectorView*>(argp1);
    result = ((arg1)->values);
    resultobj = SWIG_NewPointerObj((new std::span<uint8_t const>(result)),
                                   SWIGTYPE_p_std__spanT_uint8_t_const_t,
                                   SWIG_POINTER_OWN | 0);
    return resultobj;
fail:
    return NULL;
...
SWIGINTERN PyObject* _wrap_new_SparseVectorView(PyObject* self,
                                                PyObject* args) {
    PyObject* resultobj = 0;
    nsparse::SparseVectorView* result = 0;

    (void)self;
    if (!SWIG_Python_UnpackTuple(args, "new_SparseVectorView", 0, 0, 0))
        SWIG_fail;
    result = (nsparse::SparseVectorView*)new nsparse::SparseVectorView();
    resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result),
                                   SWIGTYPE_p_nsparse__SparseVectorView,
                                   SWIG_POINTER_NEW | 0);
    return resultobj;
fail:
    return NULL;
...
SWIGINTERN PyObject* _wrap_delete_SparseVectorView(PyObject* self,
                                                   PyObject* args) {
    PyObject* resultobj = 0;
    nsparse::SparseVectorView* arg1 = 0;
    void* argp1 = 0;
...
SWIGINTERN PyObject* SparseVectorView_swigregister(
    PyObject* SWIGUNUSEDPARM(self), PyObject* args) {
    PyObject* obj = NULL;
    if (!SWIG_Python_UnpackTuple(args, "swigregister", 1, 1, &obj)) return NULL;
    SWIG_TypeNewClientData(SWIGTYPE_p_nsparse__SparseVectorView,
                           SWIG_NewClientData(obj));
    return SWIG_Py_Void();
}

SWIGINTERN PyObject* SparseVectorView_swiginit(PyObject* SWIGUNUSEDPARM(self),
                                               PyObject* args) {
    return SWIG_Python_InitShadowInstance(args);
}

SWIGINTERN PyObject* _wrap_new_SparseVectors(PyObject* self, PyObject* args) {
    PyObject* resultobj = 0;
    nsparse::VectorValueSize arg1;
    int val1;
    int ecode1 = 0;
    PyObject* swig_obj[1];
    nsparse::SparseVectors* result = 0;
    ...
    if (!SWIG_IsOK(ecode1)) {
        SWIG_exception_fail(SWIG_ArgError(ecode1),
                            ...
                            "1"
                            " of type '"
                            "nsparse::VectorValueSize"
                            "'");
    }
    arg1 = static_cast<nsparse::VectorValueSize>(val1);
    result = (nsparse::SparseVectors*)new nsparse::SparseVectors(arg1);
    resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result),
                                   SWIGTYPE_p_nsparse__SparseVectors,
                                   SWIG_POINTER_NEW | 0);
    return resultobj;
fail:
    return NULL;
...
SWIGINTERN PyObject* _wrap_SparseVectors_add(PyObject* self, PyObject* args) {
    PyObject* resultobj = 0;
    nsparse::SparseVectors* arg1 = 0;
    std::vector<nsparse::idx_t>* arg2 = 0;
    std::vector<nsparse::term_t>* arg3 = 0;
    ...
    (void)self;
    if (!SWIG_Python_UnpackTuple(args, "SparseVectors_add", 4, 4, swig_obj))
        SWIG_fail;
    res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,
                           SWIGTYPE_p_nsparse__SparseVectors, 0 | 0);
    if (!SWIG_IsOK(res1)) {
        SWIG_exception_fail(SWIG_ArgError(res1),
                            "in method '"
                            "SparseVectors_add"
                            ...
                            "1"
                            " of type '"
                            "nsparse::SparseVectors *"
                            "'");
    }
    arg1 = reinterpret_cast<nsparse::SparseVectors*>(argp1);
    res2 = SWIG_ConvertPtr(swig_obj[1], &argp2,
                           SWIGTYPE_p_std__vectorT_int64_t_t, 0 | 0);
    if (!SWIG_IsOK(res2)) {
        SWIG_exception_fail(SWIG_ArgError(res2),
                            "in method '"
                            "SparseVectors_add"
                            ...
                            "2"
                            " of type '"
                            "std::vector< nsparse::idx_t > const &"
                            "'");
    }
    if (!argp2) {
        SWIG_exception_fail(SWIG_NullReferenceError,
    ...
    arg2 = reinterpret_cast<std::vector<nsparse::idx_t>*>(argp2);
    res3 = SWIG_ConvertPtr(swig_obj[2], &argp3,
                           SWIGTYPE_p_std__vectorT_uint32_t_t, 0 | 0);
    if (!SWIG_IsOK(res3)) {
        SWIG_exception_fail(SWIG_ArgError(res3),
                            ...
                            "3"
                            " of type '"
                            "std::vector< nsparse::term_t > const &"
                            "'");
    }
    if (!argp3) {
        SWIG_exception_fail(SWIG_NullReferenceError,
    ...
    arg3 = reinterpret_cast<std::vector<nsparse::term_t>*>(argp3);
    res4 = SWIG_ConvertPtr(swig_obj[3], &argp4, SWIGTYPE_p_std__vectorT_float_t,
                           0 | 0);
    if (!SWIG_IsOK(res4)) {
    ...
    arg4 = reinterpret_cast<std::vector<float>*>(argp4);
    (arg1)->add((std::vector<nsparse::idx_t> const&)*arg2,
                (std::vector<nsparse::term_t> const&)*arg3,
                (std::vector<float> const&)*arg4);
    resultobj = SWIG_Py_Void();
    return resultobj;
fail:
    return NULL;
...
SWIGINTERN PyObject* _wrap_SparseVectors_get_vector(PyObject* self,
                                                    PyObject* args) {
    PyObject* resultobj = 0;
    nsparse::SparseVectors* arg1 = 0;
    nsparse::idx_t arg2;
    ...
    int res1 = 0;
    PyObject* swig_obj[2];
    nsparse::SparseVectorView result;

    (void)self;
    if (!SWIG_Python_UnpackTuple(args, "SparseVectors_get_vector", 2, 2,
                                 swig_obj))
        SWIG_fail;
    res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,
                           SWIGTYPE_p_nsparse__SparseVectors, 0 | 0);
    if (!SWIG_IsOK(res1)) {
        SWIG_exception_fail(SWIG_ArgError(res1),
                            "in method '"
                            "SparseVectors_get_vector"
                            "', argument "
                            "1"
                            " of type '"
                            "nsparse::SparseVectors const *"
                            "'");
    }
    arg1 = reinterpret_cast<nsparse::SparseVectors*>(argp1);
    {
        if (PyLong_Check(swig_obj[1])) {
            arg2 = (nsparse::idx_t)PyLong_AsLongLong(swig_obj[1]);
            if (PyErr_Occurred()) {
                SWIG_fail;
            }
        } else {
    ...
    result =
        ((nsparse::SparseVectors const*)arg1)->get_vector(SWIG_STD_MOVE(arg2));
    resultobj = SWIG_NewPointerObj((new nsparse::SparseVectorView(result)),
                                   SWIGTYPE_p_nsparse__SparseVectorView,
                                   SWIG_POINTER_OWN | 0);
    return resultobj;
fail:
...
SWIGINTERN PyObject* _wrap_SparseVectors_num_vectors(PyObject* self,
                                                     PyObject* args) {
    PyObject* resultobj = 0;
    nsparse::SparseVectors* arg1 = 0;
    void* argp1 = 0;
    ...
    arg1 = reinterpret_cast<nsparse::SparseVectors*>(argp1);
    result = ((nsparse::SparseVectors const*)arg1)->num_vectors();
...
SWIGINTERN PyObject* _wrap_delete_SparseVectors(PyObject* self,
                                                PyObject* args) {
    PyObject* resultobj = 0;
    nsparse::SparseVectors* arg1 = 0;
    void* argp1 = 0;
    ...
    swig_obj[0] = args;
    res1 =
        SWIG_ConvertPtr(swig_obj[0], &argp1, SWIGTYPE_p_nsparse__SparseVectors,
                        SWIG_POINTER_DISOWN | 0);
    if (!SWIG_IsOK(res1)) {
        SWIG_exception_fail(SWIG_ArgError(res1),
                            "in method '"
                            "delete_SparseVectors"
                            "', argument "
                            "1"
                            " of type '"
                            "nsparse::SparseVectors *"
...
SWIGINTERN PyObject* SparseVectors_swigregister(PyObject* SWIGUNUSEDPARM(self),
                                                PyObject* args) {
    PyObject* obj = NULL;
    if (!SWIG_Python_UnpackTuple(args, "swigregister", 1, 1, &obj)) return NULL;
    SWIG_TypeNewClientData(SWIGTYPE_p_nsparse__SparseVectors,
                           SWIG_NewClientData(obj));
    return SWIG_Py_Void();
}

SWIGINTERN PyObject* SparseVectors_swiginit(PyObject* SWIGUNUSEDPARM(self),
                                            PyObject* args) {
    return SWIG_Python_InitShadowInstance(args);
}

SWIGINTERN PyObject* _wrap_delete_Index(PyObject* self, PyObject* args) {
    PyObject* resultobj = 0;
    nsparse::Index* arg1 = 0;
    void* argp1 = 0;
    int res1 = 0;
    PyObject* swig_obj[1];
    ...
    if (!args) SWIG_fail;
    swig_obj[0] = args;
    res1 = SWIG_ConvertPtr(swig_obj[0], &argp1, SWIGTYPE_p_nsparse__Index,
                           SWIG_POINTER_DISOWN | 0);
    if (!SWIG_IsOK(res1)) {
        SWIG_exception_fail(SWIG_ArgError(res1),
                            "in method '"
    ...
    arg1 = reinterpret_cast<nsparse::Index*>(argp1);
    delete arg1;
    resultobj = SWIG_Py_Void();
    return resultobj;
fail:
...
SWIGINTERN PyObject* _wrap_Index_add(PyObject* self, PyObject* args) {
    PyObject* resultobj = 0;
    nsparse::Index* arg1 = 0;
    nsparse::idx_t arg2;
    nsparse::idx_t* arg3 = 0;
    nsparse::term_t* arg4 = 0;
    float* arg5 = 0;
    void* argp1 = 0;
    int res1 = 0;
    PyObject* swig_obj[5];
    ...
    (void)self;
    if (!SWIG_Python_UnpackTuple(args, "Index_add", 5, 5, swig_obj)) SWIG_fail;
    res1 =
        SWIG_ConvertPtr(swig_obj[0], &argp1, SWIGTYPE_p_nsparse__Index, 0 | 0);
    if (!SWIG_IsOK(res1)) {
        SWIG_exception_fail(SWIG_ArgError(res1),
                            "in method '"
                            "Index_add"
    ...
    {
        Py_buffer view;
        if (PyObject_GetBuffer(swig_obj[2], &view,
                               PyBUF_FORMAT | PyBUF_C_CONTIGUOUS) == -1) {
            SWIG_fail;
        }
        if (strcmp(view.format, "q") != 0 && strcmp(view.format, "l") != 0) {
            PyBuffer_Release(&view);
            PyErr_SetString(PyExc_TypeError, "Expected int64 array for indptr");
            SWIG_fail;
        }
        arg3 = (nsparse::idx_t*)view.buf;
        PyBuffer_Release(&view);
    }
    {
        Py_buffer view;
        if (PyObject_GetBuffer(swig_obj[3], &view,
                               PyBUF_FORMAT | PyBUF_C_CONTIGUOUS) == -1) {
            SWIG_fail;
        }
        if (strcmp(view.format, "H") != 0) {
            PyBuffer_Release(&view);
            PyErr_SetString(PyExc_TypeError,
                            "Expected uint16 array for indices");
            SWIG_fail;
        }
        arg4 = (nsparse::term_t*)view.buf;
        PyBuffer_Release(&view);
    }
    {
        Py_buffer view;
        if (PyObject_GetBuffer(swig_obj[4], &view,
                               PyBUF_FORMAT | PyBUF_C_CONTIGUOUS) == -1) {
            SWIG_fail;
        }
        if (strcmp(view.format, "f") != 0) {
            PyBuffer_Release(&view);
            PyErr_SetString(PyExc_TypeError,
                            "Expected float32 array for values");
            SWIG_fail;
        }
        arg5 = (float*)view.buf;
        PyBuffer_Release(&view);
    }
    (arg1)->add(SWIG_STD_MOVE(arg2), (nsparse::idx_t const*)arg3,
                (nsparse::term_t const*)arg4, (float const*)arg5);
    resultobj = SWIG_Py_Void();
    return resultobj;
fail:
    return NULL;
...
SWIGINTERN PyObject* _wrap_Index_search(PyObject* self, PyObject* args) {
    PyObject* resultobj = 0;
    nsparse::Index* arg1 = 0;
    nsparse::idx_t arg2;
    nsparse::idx_t* arg3 = 0;
    ...
    float* arg5 = 0;
    int arg6;
    nsparse::idx_t* arg7 = 0;
    void* argp1 = 0;
    int res1 = 0;
    nsparse::idx_t* temp7;
    nsparse::idx_t n_store7;
    int k_store7;
    PyObject* swig_obj[6];
    ...
    (void)self;
    if (!SWIG_Python_UnpackTuple(args, "Index_search", 6, 6, swig_obj))
        SWIG_fail;
    res1 =
        SWIG_ConvertPtr(swig_obj[0], &argp1, SWIGTYPE_p_nsparse__Index, 0 | 0);
    if (!SWIG_IsOK(res1)) {
    ...
    }
    {
        if (PyLong_Check(swig_obj[5])) {
            arg6 = (int)PyLong_AsLong(swig_obj[5]);
            if (PyErr_Occurred()) {
                SWIG_fail;
            }
        } else {
            PyErr_SetString(PyExc_TypeError,
                            "Expected an integer for k parameter");
            SWIG_fail;
        }
    }
    {
        // Store n and k in the local variables from the labels typemap
        n_store7 = arg2;  // n (note: labels is arg 7, so locals are numbered 7)
        k_store7 = arg6;  // k
        // Allocate labels array: n * k
        arg7 = new nsparse::idx_t[arg2 * arg6];
    }
    (arg1)->search(SWIG_STD_MOVE(arg2), (nsparse::idx_t const*)arg3,
                   (nsparse::term_t const*)arg4, (float const*)arg5, arg6,
                   arg7);
    resultobj = SWIG_Py_Void();
    {
        // Create a 2D array with shape (n, k)
        npy_intp dims[2];
        dims[0] = n_store7;  // n (number of queries)
        dims[1] = k_store7;  // k (number of neighbors per query)

        PyObject* array =
            PyArray_SimpleNewFromData(2, dims, NPY_INT64, (void*)arg7);
        if (!array) {
            delete[] arg7;
            SWIG_fail;
        }
        ...
        resultobj = SWIG_Python_AppendOutput(resultobj, array, 1);
    }
    return resultobj;
fail:
    return NULL;
...
SWIGINTERN PyObject* _wrap_Index_get_vectors(PyObject* self, PyObject* args) {
    PyObject* resultobj = 0;
    nsparse::Index* arg1 = 0;
    void* argp1 = 0;
    int res1 = 0;
    ...
    arg1 = reinterpret_cast<nsparse::Index*>(argp1);
    result =
        (nsparse::SparseVectors*)((nsparse::Index const*)arg1)->get_vectors();
    resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result),
                                   SWIGTYPE_p_nsparse__SparseVectors, 0 | 0);
    return resultobj;
fail:
...
SWIGINTERN PyObject* Index_swigregister(PyObject* SWIGUNUSEDPARM(self),
                                        PyObject* args) {
    PyObject* obj = NULL;
    if (!SWIG_Python_UnpackTuple(args, "swigregister", 1, 1, &obj)) return NULL;
    SWIG_TypeNewClientData(SWIGTYPE_p_nsparse__Index, SWIG_NewClientData(obj));
    return SWIG_Py_Void();
}

SWIGINTERN PyObject* _wrap_new_BrutalIndex(PyObject* self, PyObject* args) {
    PyObject* resultobj = 0;
    nsparse::BrutalIndex* result = 0;

    (void)self;
    if (!SWIG_Python_UnpackTuple(args, "new_BrutalIndex", 0, 0, 0)) SWIG_fail;
    result = (nsparse::BrutalIndex*)new nsparse::BrutalIndex();
    resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result),
                                   SWIGTYPE_p_nsparse__BrutalIndex,
                                   SWIG_POINTER_NEW | 0);
    return resultobj;
fail:
    return NULL;
...
SWIGINTERN PyObject* _wrap_delete_BrutalIndex(PyObject* self, PyObject* args) {
    PyObject* resultobj = 0;
    nsparse::BrutalIndex* arg1 = 0;
    void* argp1 = 0;
    int res1 = 0;
    PyObject* swig_obj[1];
    ...
    if (!args) SWIG_fail;
    swig_obj[0] = args;
    res1 = SWIG_ConvertPtr(swig_obj[0], &argp1, SWIGTYPE_p_nsparse__BrutalIndex,
                           SWIG_POINTER_DISOWN | 0);
    if (!SWIG_IsOK(res1)) {
        SWIG_exception_fail(SWIG_ArgError(res1),
                            "in method '"
    ...
    arg1 = reinterpret_cast<nsparse::BrutalIndex*>(argp1);
    delete arg1;
    resultobj = SWIG_Py_Void();
    return resultobj;
fail:
...
SWIGINTERN PyObject* BrutalIndex_swigregister(PyObject* SWIGUNUSEDPARM(self),
                                              PyObject* args) {
    PyObject* obj = NULL;
    if (!SWIG_Python_UnpackTuple(args, "swigregister", 1, 1, &obj)) return NULL;
    SWIG_TypeNewClientData(SWIGTYPE_p_nsparse__BrutalIndex,
                           SWIG_NewClientData(obj));
    return SWIG_Py_Void();
}

SWIGINTERN PyObject* BrutalIndex_swiginit(PyObject* SWIGUNUSEDPARM(self),
                                          PyObject* args) {
    return SWIG_Python_InitShadowInstance(args);
}

static PyMethodDef SwigMethods[] = {
    {"SparseVectorView_indices_set", _wrap_SparseVectorView_indices_set,
     METH_VARARGS, NULL},
    {"SparseVectorView_indices_get", _wrap_SparseVectorView_indices_get, METH_O,
     NULL},
    {"SparseVectorView_values_set", _wrap_SparseVectorView_values_set,
     METH_VARARGS, NULL},
    {"SparseVectorView_values_get", _wrap_SparseVectorView_values_get, METH_O,
     NULL},
    {"new_SparseVectorView", _wrap_new_SparseVectorView, METH_NOARGS, NULL},
    {"delete_SparseVectorView", _wrap_delete_SparseVectorView, METH_O, NULL},
    {"SparseVectorView_swigregister", SparseVectorView_swigregister, METH_O,
     NULL},
    {"SparseVectorView_swiginit", SparseVectorView_swiginit, METH_VARARGS,
     NULL},
    {"new_SparseVectors", _wrap_new_SparseVectors, METH_O, NULL},
    {"SparseVectors_add", _wrap_SparseVectors_add, METH_VARARGS, NULL},
    {"SparseVectors_get_vector", _wrap_SparseVectors_get_vector, METH_VARARGS,
     NULL},
    {"SparseVectors_num_vectors", _wrap_SparseVectors_num_vectors, METH_O,
     NULL},
    {"delete_SparseVectors", _wrap_delete_SparseVectors, METH_O, NULL},
    {"SparseVectors_swigregister", SparseVectors_swigregister, METH_O, NULL},
    {"SparseVectors_swiginit", SparseVectors_swiginit, METH_VARARGS, NULL},
    ...
    {"Index_get_vectors", _wrap_Index_get_vectors, METH_O, NULL},
    {"Index_swigregister", Index_swigregister, METH_O, NULL},
    {"new_BrutalIndex", _wrap_new_BrutalIndex, METH_NOARGS, NULL},
    {"delete_BrutalIndex", _wrap_delete_BrutalIndex, METH_O, NULL},
    {"BrutalIndex_swigregister", BrutalIndex_swigregister, METH_O, NULL},
    {"BrutalIndex_swiginit", BrutalIndex_swiginit, METH_VARARGS, NULL},
    {NULL, NULL, 0, NULL}};

/* -------- TYPE CONVERSION AND EQUIVALENCE RULES (BEGIN) -------- */

static void* _p_nsparse__BrutalIndexTo_p_nsparse__Index(
    void* x, int* SWIGUNUSEDPARM(newmemory)) {
    return (void*)((nsparse::Index*)((nsparse::BrutalIndex*)x));
}
static swig_type_info _swigt__p_nsparse__BrutalIndex = {
    "_p_nsparse__BrutalIndex", "nsparse::BrutalIndex *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_nsparse__Index = {
    "_p_nsparse__Index", "nsparse::Index *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_nsparse__SparseVectorView = {
    "_p_nsparse__SparseVectorView",
    "nsparse::SparseVectorView *",
    0,
    0,
    (void*)0,
    0};
static swig_type_info _swigt__p_nsparse__SparseVectors = {
    "_p_nsparse__SparseVectors", "nsparse::SparseVectors *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_float = {
    "_p_float", "nsparse::weight_t *|float *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_int64_t = {
    "_p_int64_t", "nsparse::idx_t *|int64_t *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_std__spanT_uint32_t_const_t = {
    "_p_std__spanT_uint32_t_const_t",
    "std::span< nsparse::term_t const > *|std::span< uint32_t const > *",
    0,
    0,
    (void*)0,
    0};
static swig_type_info _swigt__p_std__spanT_uint8_t_const_t = {
    "_p_std__spanT_uint8_t_const_t",
    "std::span< uint8_t const > *",
    0,
    0,
    (void*)0,
    0};
static swig_type_info _swigt__p_std__vectorT_float_t = {
    "_p_std__vectorT_float_t", "std::vector< float > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_std__vectorT_int64_t_t = {
    "_p_std__vectorT_int64_t_t",
    "std::vector< nsparse::idx_t > *|std::vector< int64_t > *",
    0,
    0,
    (void*)0,
    0};
static swig_type_info _swigt__p_std__vectorT_uint32_t_t = {
    "_p_std__vectorT_uint32_t_t",
    "std::vector< nsparse::term_t > *|std::vector< uint32_t > *",
    0,
    0,
    (void*)0,
    0};
static swig_type_info _swigt__p_uint32_t = {
    "_p_uint32_t", "nsparse::term_t *|uint32_t *", 0, 0, (void*)0, 0};

static swig_type_info* swig_type_initial[] = {
    &_swigt__p_nsparse__BrutalIndex,
    &_swigt__p_nsparse__Index,
    &_swigt__p_nsparse__SparseVectorView,
    &_swigt__p_nsparse__SparseVectors,
    &_swigt__p_char,
    &_swigt__p_float,
    &_swigt__p_int64_t,
    &_swigt__p_std__spanT_uint32_t_const_t,
    &_swigt__p_std__spanT_uint8_t_const_t,
...
static swig_cast_info _swigc__p_nsparse__BrutalIndex[] = {
    {&_swigt__p_nsparse__BrutalIndex, 0, 0, 0}, {0, 0, 0, 0}};
static swig_cast_info _swigc__p_nsparse__Index[] = {
    {&_swigt__p_nsparse__Index, 0, 0, 0},
    {&_swigt__p_nsparse__BrutalIndex,
     _p_nsparse__BrutalIndexTo_p_nsparse__Index, 0, 0},
    {0, 0, 0, 0}};
static swig_cast_info _swigc__p_nsparse__SparseVectorView[] = {
    {&_swigt__p_nsparse__SparseVectorView, 0, 0, 0}, {0, 0, 0, 0}};
static swig_cast_info _swigc__p_nsparse__SparseVectors[] = {
    {&_swigt__p_nsparse__SparseVectors, 0, 0, 0}, {0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {{&_swigt__p_char, 0, 0, 0},
                                          {0, 0, 0, 0}};
static swig_cast_info _swigc__p_float[] = {{&_swigt__p_float, 0, 0, 0},
                                           {0, 0, 0, 0}};
static swig_cast_info _swigc__p_int64_t[] = {{&_swigt__p_int64_t, 0, 0, 0},
                                             {0, 0, 0, 0}};
static swig_cast_info _swigc__p_std__spanT_uint32_t_const_t[] = {
    {&_swigt__p_std__spanT_uint32_t_const_t, 0, 0, 0}, {0, 0, 0, 0}};
static swig_cast_info _swigc__p_std__spanT_uint8_t_const_t[] = {
    {&_swigt__p_std__spanT_uint8_t_const_t, 0, 0, 0}, {0, 0, 0, 0}};
static swig_cast_info _swigc__p_std__vectorT_float_t[] = {
    {&_swigt__p_std__vectorT_float_t, 0, 0, 0}, {0, 0, 0, 0}};
static swig_cast_info _swigc__p_std__vectorT_int64_t_t[] = {
    {&_swigt__p_std__vectorT_int64_t_t, 0, 0, 0}, {0, 0, 0, 0}};
static swig_cast_info _swigc__p_std__vectorT_uint32_t_t[] = {
    {&_swigt__p_std__vectorT_uint32_t_t, 0, 0, 0}, {0, 0, 0, 0}};
static swig_cast_info _swigc__p_uint32_t[] = {{&_swigt__p_uint32_t, 0, 0, 0},
                                              {0, 0, 0, 0}};

static swig_cast_info* swig_cast_initial[] = {
    _swigc__p_nsparse__BrutalIndex,
    _swigc__p_nsparse__Index,
    _swigc__p_nsparse__SparseVectorView,
    _swigc__p_nsparse__SparseVectors,
    _swigc__p_char,
    _swigc__p_float,
    _swigc__p_int64_t,
    _swigc__p_std__spanT_uint32_t_const_t,
    _swigc__p_std__spanT_uint8_t_const_t,
...
SWIGINTERN int SWIG_CastCmpStruct(const void* pa, const void* pb) {
    ...
    if (pca->type < pcb->type) return (pca->next || pcb->next == 0) ? -1 : 1;
    if (pca->type > pcb->type) return (pcb->next || pca->next == 0) ? 1 : -1;
    return 0;
}
    ...
    for (i = 0; i < swig_module.size; ++i) {
        ...
        while (cast->type) {
...
#endif
            if (swig_module.next != &swig_module) {
                target_type = SWIG_MangledTypeQueryModule(
                ...
                if (target_type) {
                    ...
                    if (type == swig_module.type_initial[i]) {
                        ...
                        swig_cast_info* ocast =
                            SWIG_TypeCheck(target_type->name, type);
#ifdef SWIGRUNTIME_DEBUG
                        if (ocast)
            ...
            if (!target_type) {
                ...
                if (type == cast->type) {
                    ...
                    cast->value =
                        SWIG_Hash(cast->type->name,
                                  (unsigned int)strlen(cast->type->name));
                }
            }
            cast++;
        }
        ...
        if (num_mapped) {
            if (cast - first) {
                ...
                /* Sort casts by type address for binary search in
                 * SWIG_TypeCheckStruct */
                qsort(first, cast - first, sizeof(swig_cast_info),
                      SWIG_CastCmpStruct);
            ...
            /* Set the value field of the first entry to the index of the last
             * added entry */
            ...
            if (num_mapped > 1) {
                /* Sort <'next','value'> pairs by 'value' for binary search in
                 * SWIG_TypeCheck */
                ...
                for (cast = head; (cast - head) <= head->value; cast++) {
                    if (!cast->converter) {
                        if (cast->type && !cast->type->clientdata)
                            SWIG_TypeClientData(
                                cast->type, swig_module.types[i]->clientdata);
                    }
                }
                head = head->next;
            }
...
SWIGINTERN void SWIG_Python_InstallConstants(PyObject* d,
    ...
    for (i = 0; constants[i].type; ++i) {
        switch (constants[i].type) {
            ...
            case SWIG_PY_BINARY:
                obj =
                    SWIG_NewPackedObj(constants[i].pvalue, constants[i].lvalue,
                                      *(constants[i].ptype));
                break;
            default:
                obj = 0;
...
void
    ...
    SWIG_init(void) {
#if PY_VERSION_HEX >= 0x03000000
    static PyModuleDef_Slot SwigSlots[] = {{Py_mod_exec, (void*)SWIG_mod_exec},
...
SWIGINTERN int SWIG_mod_exec(PyObject* m) {
    ...
    SWIG_Python_SetConstant(d, "U8",
                            SWIG_From_int(static_cast<int>(nsparse::U8)));
    SWIG_Python_SetConstant(d, "U16",
                            SWIG_From_int(static_cast<int>(nsparse::U16)));
    SWIG_Python_SetConstant(d, "U32",
                            SWIG_From_int(static_cast<int>(nsparse::U32)));
    SWIG_Python_SetConstant(d, "U64",
                            SWIG_From_int(static_cast<int>(nsparse::U64)));
    return 0;
}
